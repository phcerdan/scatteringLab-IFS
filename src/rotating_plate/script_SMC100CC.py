...
if __name__ == '__main__':
    ...
    parser.add_argument('--start_scatering_angle', action='store', type=float,
            default=40,
            help='start scatering angle')
    parser.add_argument('--end_scatering_angle', action='store', type=float,
            default=140,
            help='end scatering angle')
    parser.add_argument('--step_size_rotating', action='store', type=float,
            default=1,
    ...
    parser.add_argument('--correlator_out_folder', action='store',
    ...
    ### ROTATING PLATE
    startScatAng = args.start_scatering_angle
    endScatAng = args.end_scatering_angle
    ...
    correlator_out_folder_path = os.path.abspath(args.correlator_out_folder)
